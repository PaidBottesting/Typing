...
TOKEN = os.getenv("8094930692:AAGy-bnpYA0A1j6B3lRWol-GyfK9gtiMwCo")
ADMIN_ID = int(os.getenv("1866961136"))
GROUP_ID = int(os.getenv("-1002328886935"))
...
# Add Coins
@dp.message_handler(commands=['add_coins'])
...
# Reseller Stats
@dp.message_handler(commands=['reseller_stats'])
...
async def set_price(message: Message):
    ...
    day SKU = {"1H": 50, "1D": 100, "3D": 500, "7D": 700, "30D": 1500}
...
async def track_invites(update: types.ChatMemberUpdated):
...
if __name__ == "__main__":
    ...
    loop.create_task(check_vip_expiry())
